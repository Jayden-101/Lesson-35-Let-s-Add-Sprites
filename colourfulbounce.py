...
class Sprite(pygame.sprite.Sprite):
    ...
    def __init__(self, color, height, width):
        ...
        super().__init__()
        # Create the sprite's surface with deminsions and color
   ...
   # If a boundary was hit, post events to change colors
    ...
    def change_color(self):
        self.image.fill(random.choice([YELLOW, MAGENTA, ORANGE, WHITE, BLACK]))

# Function to change the background color
def change_background_color():
    global bg_color
    bg_color = random.choice([BLUE, LIGHTBLUE, DARKBLUE, GREEN, RED])
...
while not exit:
    ...
    # fill the screen with the cunrrent background color
    screen.fill(bg_color)
